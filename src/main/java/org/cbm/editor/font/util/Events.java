...
public class Events implements Runnable
{
    ...
    private static class Producer
    {
        ...
        public Producer()
        {
            ...
            consumerReferences = new LinkedHashSet<>();
        }
     ...
     */
    private static final ThreadLocal<Integer> DISABLED = new ThreadLocal<>();
    ...
    private Events()
    {
        ...
        pendingBinds = new ConcurrentLinkedQueue<>();
        pendingUnbinds = new ConcurrentLinkedQueue<>();
    ...
    private void handlePendingLinks()
    {
        ...
        synchronized (pendingBinds)
        {
            while ((pendingBind = pendingBinds.poll()) != null)
            {
                final Reference<Object> consumerReference =
                    new WeakIdentityReference<>(pendingBind.getConsumer());
                final Reference<Object> producerReference =
                    new WeakIdentityReference<>(pendingBind.getProducer());
        ...
        {
            final Reference<Object> consumerReference = new WeakIdentityReference<>(pendingUnbind.getConsumer());
            final Reference<Object> producerReference = new WeakIdentityReference<>(pendingUnbind.getProducer());
    ...
    {
        final Reference<Object> producerReference = new WeakIdentityReference<>(event.getProducer());
        final Producer producer = producers.get(producerReference);
