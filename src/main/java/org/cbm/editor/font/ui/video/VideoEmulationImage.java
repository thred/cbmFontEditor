...
public class VideoEmulationImage extends BufferedImage
{
    ...
    public static VideoEmulationImage create(final VideoEmulationImage existing, final VideoEmulationSettings settings,
        final int width, final int height)
    {
        ...
        switch (settings.getDisplayMode())
        {
            ...
            case BLACK_AND_WHITE_TV:
                imageWidth = (int) (settings.getSignalMode().getStandard().getLumaPerPixel()
                    * width
                    * settings.getPhysicalResolution()) + 1;
                break;
        ...
        if (existing == null
            || imageWidth != existing.getWidth()
            || imageHeight != existing.getHeight()
