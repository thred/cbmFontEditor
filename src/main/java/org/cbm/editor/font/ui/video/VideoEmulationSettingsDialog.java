...
public class VideoEmulationSettingsDialog extends JDialog implements ActionListener
{
	...
	public VideoEmulationSettingsDialog()
	{
		...
		signalModeComboBox = new JComboBox<VideoEmulationSignalMode>(VideoEmulationSignalMode.values());
		...
		displayModeComboBox = new JComboBox<VideoEmulationDisplayMode>(VideoEmulationDisplayMode.values());
