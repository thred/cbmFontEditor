...
public enum VideoEmulationStandard
{
	...
	private VideoEmulationStandard(final float frameFrequency, final int colorShiftLines, final boolean oddLinePhaseShift, final int horizontalResolution, final int verticalResolution)
	{
	...
	private VideoEmulationStandard(final float frameFrequency, final float lineFrequency, final float videoBandwidth, final float colorBandwidth, final int colorShiftLines, final float horizontalVisible, final float verticalVisible, final boolean oddLinePhaseShift, final int horizontalResolution, final int verticalResolution)
	{
		this.frameFrequency = frameFrequency;
