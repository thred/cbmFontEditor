    ...
    public void actionPerformed(final ActionEvent event)
    {
        ...
        while (!foundFile)
        {
            final File path = new File(
                Prefs.get("save.path", file != null ? file.getAbsolutePath() : System.getProperty("user.home")));
            ...
            {
                final int confirm =
                    UIUtils.confirmOrAbort(Registry.get(MainFrameController.class).getView(), "Save Project As...",
