...
public class AcceptSelectionAction extends AbstractAction
{
    ...
    public void updateState()
    {
        ...
        setEnabled(
            component != null && component.getDropLayer() != null && component.getDropLayer().hasBlockSelection());
    }
    ...
    public void actionPerformed(final ActionEvent e)
    {
        ...
        switch (guiAdapter.getActiveComponentType())
        {
            ...
            case FONT:
                Registry
                    .execute(new FontAcceptEdit(component.getRootLayer().getFont(), component.getRootLayer().getBlock(),
                        dropLayer.getXInCharacter(), dropLayer.getYInCharacter(), dropLayer.getBlockSelection()));
            ...
            case EDIT:
                Registry
                    .execute(new EditAcceptEdit(component.getRootLayer().getFont(), component.getRootLayer().getBlock(),
                        dropLayer.getXInPixel(), dropLayer.getYInPixel(), dropLayer.getBlockSelection()));
