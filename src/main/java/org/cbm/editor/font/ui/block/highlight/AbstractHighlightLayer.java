...
public abstract class AbstractHighlightLayer extends AbstractLayer implements HighlightLayer, MouseListener,
		MouseMotionListener, MouseWheelListener
{

	private static final Stroke HIGHLIGHT_STROKE = new BasicStroke(1, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 0,
			new float[] {
					4, 4
			}, 0);
	private static final Stroke HIGHLIGHT_BACKGROUND_STROKE = new BasicStroke(1, BasicStroke.CAP_ROUND,
