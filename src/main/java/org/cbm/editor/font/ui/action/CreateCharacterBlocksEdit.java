...
public class CreateCharacterBlocksEdit extends AbstractEdit
{
    ...
    private static final Characters[] UNSHIFTED_LETTERS = {
        Characters.A_UNSHIFTED,
        Characters.B_UNSHIFTED,
        Characters.C_UNSHIFTED,
        Characters.D_UNSHIFTED,
        Characters.E_UNSHIFTED,
        Characters.F_UNSHIFTED,
        Characters.G_UNSHIFTED,
        Characters.H_UNSHIFTED,
        Characters.I_UNSHIFTED,
        Characters.J_UNSHIFTED,
        Characters.K_UNSHIFTED,
        Characters.L_UNSHIFTED,
        Characters.M_UNSHIFTED,
        Characters.N_UNSHIFTED,
        Characters.O_UNSHIFTED,
        Characters.P_UNSHIFTED,
        Characters.Q_UNSHIFTED,
        Characters.R_UNSHIFTED,
        Characters.S_UNSHIFTED,
        Characters.T_UNSHIFTED,
        Characters.U_UNSHIFTED,
        Characters.V_UNSHIFTED,
        Characters.W_UNSHIFTED,
        Characters.X_UNSHIFTED,
        Characters.Y_UNSHIFTED,
        Characters.Z_UNSHIFTED};

    private static final Characters[] SHIFTED_LETTERS = {
        Characters.A_SHIFTED,
        Characters.B_SHIFTED,
        Characters.C_SHIFTED,
        Characters.D_SHIFTED,
        Characters.E_SHIFTED,
        Characters.F_SHIFTED,
        Characters.G_SHIFTED,
        Characters.H_SHIFTED,
        Characters.I_SHIFTED,
        Characters.J_SHIFTED,
        Characters.K_SHIFTED,
        Characters.L_SHIFTED,
        Characters.M_SHIFTED,
        Characters.N_SHIFTED,
        Characters.O_SHIFTED,
        Characters.P_SHIFTED,
        Characters.Q_SHIFTED,
        Characters.R_SHIFTED,
        Characters.S_SHIFTED,
        Characters.T_SHIFTED,
        Characters.U_SHIFTED,
        Characters.V_SHIFTED,
        Characters.W_SHIFTED,
        Characters.X_SHIFTED,
        Characters.Y_SHIFTED,
        Characters.Z_SHIFTED,
    ...
    public static final Characters[] SPECIAL_CHARACTERS = {
        Characters.AT,
        Characters.OPEN_SQUARE_BRACKET,
        Characters.POUND_SIGN,
        Characters.CLOSE_SQUARE_BRACKET,
        Characters.ARROW_UP,
        Characters.ARROW_LEFT,
        Characters.SPACE,
        Characters.EXCLAMATION_MARK,
        Characters.QUOTATION_MARK,
        Characters.NUMBER_SIGN,
        Characters.DOLLAR_SIGN,
        Characters.PERCENT_SIGN,
        Characters.AMPERSAND,
        Characters.APOSTROPHE,
        Characters.LEFT_PARENTHESIS,
        Characters.RIGHT_PARENTHESIS,
        Characters.ASTERISK,
        Characters.PLUS_SIGN,
        Characters.COMMA,
        Characters.HYPHEN_MINUS,
        Characters.FULL_STOP,
        Characters.SOLIDUS,
        Characters.COLON,
        Characters.SEMICOLON,
        Characters.LESS_THAN_SIGN,
        Characters.EQUALS_SIGN,
        Characters.GREATER_THAN_SIGN,
        Characters.QUESTION_MARK};
