...
public class BlockPanel extends JPanel implements ChangeListener, ActionListener, MouseListener, MouseMotionListener,
		MouseWheelListener
{
	...
	{
		return new Point(point.x - scrollPane.getHorizontalScrollBar().getValue(), point.y
			...
			SwingUtilities.invokeLater(new Runnable()
			{
				...
				public void run()
				{
					...
					if (currentZoom != nextZoom)
					{
						...
						final Point positionInPixel = blockComponent.convertFromComponentToPixel(new Point(zoomPoint.x
								+ viewPosition.x, zoomPoint.y + viewPosition.y));
						...
						SwingUtilities.invokeLater(new Runnable()
						{
							...
							public void run()
							{
								final Point viewPosition = blockComponent.convertFromPixelToComponent(positionInPixel);

								viewPosition.x -= zoomPoint.x;
								viewPosition.y -= zoomPoint.y;

								scrollPane.getHorizontalScrollBar().setValue(viewPosition.x);
