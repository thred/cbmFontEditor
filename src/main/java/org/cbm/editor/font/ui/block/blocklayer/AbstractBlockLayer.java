...
import org.cbm.editor.font.ui.block.select.Selector;
...
public abstract class AbstractBlockLayer extends AbstractLayer implements BlockLayer
{
	...
	private static final Icon[] ICONS = {
			Icon.GRID0, Icon.GRID1, Icon.GRID2, Icon.GRID3, Icon.GRID4, Icon.GRID5, Icon.GRID6, Icon.GRID7, Icon.GRID8,
			Icon.GRID9, Icon.GRID10, Icon.GRID11, Icon.GRID12, Icon.GRID13, Icon.GRID14, Icon.GRID15
	};
	...
	public BlockSelection createBlockSelection(Rectangle rectangle)
	{
		...
		Rectangle copiedRectangle = new Rectangle(rectangle.x - (x * block.getCharacterWidth()), rectangle.y
				- (y * block.getCharacterHeight()), rectangle.width, rectangle.height);
	...
	{
		final int value = ((isCharacterAvailable(x - 1, y - 1)) ? 1 : 0) + ((isCharacterAvailable(x, y - 1)) ? 2 : 0)
				+ ((isCharacterAvailable(x - 1, y)) ? 4 : 0) + ((isCharacterAvailable(x, y)) ? 8 : 0);
