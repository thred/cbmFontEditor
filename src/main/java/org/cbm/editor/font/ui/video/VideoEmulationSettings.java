...
public class VideoEmulationSettings
{
    ...
    public VideoEmulationSettings(final VideoEmulationSignalMode signalMode,
        final VideoEmulationDisplayMode displayMode, final float lumaSharpness, final float shift,
        final float physicalResolution)
    {
        super();
    ...
    public boolean isImageCompatible(final VideoEmulationSettings settings)
    {
        ...
        return signalMode.equals(settings.getSignalMode())
            && displayMode.equals(settings.getDisplayMode())
            && physicalResolution == settings.getPhysicalResolution();
    }
