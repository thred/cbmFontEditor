...
public class CreateCharacterBlocksDialog extends JDialog implements ActionListener
{
    ...
    public CreateCharacterBlocksDialog()
    {
        ...
        characterModeComboBox = new JComboBox<>(CharacterMode.values());
        characterModeComboBox.setSelectedItem(CharacterMode.CHARACTER_1_1);

        letterModeComboBox = new JComboBox<>(LetterMode.values());
        ...
        panel.add(specialCharactersCheckBox = UIUtils.createCheckBox("Create special characters", true),
            c.nextLine().width(2));

        panel.add(umlautCharactersCheckBox = UIUtils.createCheckBox("Create umlaut characters for german", false),
            c.nextLine().width(2));
    ...
    public void actionPerformed(final ActionEvent e)
    {
        ...
        else if (e.getSource() == okButton)
        {
            ...
            final int index = Registry.get(ProjectAdapter.class).getProject().indexOfBlock(
                Registry.get(BlockAdapter.class).getBlock()) + 1;
